...
<h2 class="wp-block-heading has-background-color has-text-color has-rowdies-font-family" style="font-size:22px;font-style:normal;font-weight:400">'. esc_html('Helps','rt-education-school') .'</h2>
<!-- /wp:heading -->

<!-- wp:navigation {"overlayMenu":"never","layout":{"type":"flex","orientation":"vertical"},"style":{"typography":{"fontStyle":"normal","fontWeight":"400"}},"fontSize":"medium","fontFamily":"saira"} -->
...
<!-- wp:navigation-link {"label":"Terms And Conditions","type":"","url":"#","kind":"custom","isTopLevelLink":true} /-->

<!-- wp:navigation-link {"label":"Shipping details","type":"","url":"#","kind":"custom","isTopLevelLink":true} /-->
...
<h2 class="wp-block-heading has-background-color has-text-color has-rowdies-font-family" style="font-size:22px;font-style:normal;font-weight:400">'. esc_html('Categories','rt-education-school') .'</h2>
<!-- /wp:heading -->

<!-- wp:navigation {"overlayMenu":"never","layout":{"type":"flex","orientation":"vertical"},"style":{"typography":{"fontStyle":"normal","fontWeight":"400"}},"fontSize":"medium","fontFamily":"saira"} -->
<!-- wp:navigation-link {"label":"Design Skills","type":"","url":"#","kind":"custom","isTopLevelLink":true} /-->

<!-- wp:navigation-link {"label":"Development","type":"","url":"#","kind":"custom","isTopLevelLink":true} /-->

<!-- wp:navigation-link {"label":"Marketing Finance","type":"","url":"#","kind":"custom","isTopLevelLink":true} /-->

<!-- wp:navigation-link {"label":"Accounting IT","type":"","url":"#","kind":"custom","isTopLevelLink":true} /-->

<!-- wp:navigation-link {"label":"Software Sales","type":"","url":"#","kind":"custom","isTopLevelLink":true} /-->
...
<h2 class="wp-block-heading has-background-color has-text-color has-rowdies-font-family" style="font-size:22px;font-style:normal;font-weight:400">'. esc_html('Quick Links','rt-education-school') .'</h2>
<!-- /wp:heading -->

<!-- wp:navigation {"overlayMenu":"never","className":"is-head-menu","layout":{"type":"flex","justifyContent":"left","orientation":"vertical"},"style":{"typography":{"fontStyle":"normal","fontWeight":"400"}},"fontSize":"medium","fontFamily":"saira"} -->
...
<!-- wp:navigation-link {"label":"Buy Now","type":"link","opensInNewTab":true,"url":"https://www.wpradiant.net/products/school-wordpress-theme/","kind":"custom","className":"getpro"} /-->
...
<!-- wp:paragraph {"align":"left","style":{"elements":{"link":{"color":{"text":"var:preset|color|background"}}},"typography":{"fontStyle":"normal","fontWeight":"400"}},"textColor":"background","fontSize":"medium","fontFamily":"saira"} -->
<p class="has-text-align-left has-background-color has-text-color has-link-color has-saira-font-family has-medium-font-size" style="font-style:normal;font-weight:400"><span class="dashicons dashicons-email-alt"></span>  '. esc_html('support@example.com','rt-education-school') .'</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|background"}}},"typography":{"fontStyle":"normal","fontWeight":"400"}},"textColor":"background","fontSize":"medium","fontFamily":"saira"} -->
<p class="has-background-color has-text-color has-link-color has-saira-font-family has-medium-font-size" style="font-style:normal;font-weight:400"><span class="dashicons dashicons-phone"></span>  +123 456 7890</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|background"}}},"typography":{"fontStyle":"normal","fontWeight":"400"}},"textColor":"background","fontSize":"medium","fontFamily":"saira"} -->
<p class="has-background-color has-text-color has-link-color has-saira-font-family has-medium-font-size" style="font-style:normal;font-weight:400"><span class="dashicons dashicons-admin-home"></span>  '. esc_html('123, Red Hills, Chicago,IL, USA','rt-education-school') .'</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->
