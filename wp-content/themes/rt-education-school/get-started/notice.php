...
define('RT_EDUCATION_SCHOOL_NOTICE_BUY_NOW',__('https://www.wpradiant.net/products/school-wordpress-theme/','rt-education-school'));

define('RT_EDUCATION_SCHOOL_BUY_BUNDLE',__('https://www.wpradiant.net/products/wordpress-theme-bundle/','rt-education-school'));
...
function rt_education_school_admin_notice_style() {
	wp_enqueue_style('rt-education-school-custom-admin-notice-style', esc_url(get_template_directory_uri()) . '/get-started/getstart.css');
}
add_action('admin_enqueue_scripts', 'rt_education_school_admin_notice_style');
        ...
        <div class="updated notice notice-success is-dismissible notice-get-started-class" data-notice="get-start" style="display: flex;padding: 10px;">
        		<div class="notice-content">
	        		<div class="notice-holder">
	                        <h5><span class="theme-name"><span><?php echo __('Welcome to RT Education School', 'rt-education-school'); ?></span></h5>
	                        <h1><?php echo __('Enhance Your Website Development with Radiant Blocks!!', 'rt-education-school'); ?></h1>
	                        </h3>
	                        <div class="notice-text">
	                            <p class="blocks-text"><?php echo __('Effortlessly craft websites for any niche with Radiant Blocks! Experience seamless functionality and stunning responsiveness as you enhance your digital presence with Block WordPress Themes. Start building your ideal website today!', 'rt-education-school') ?></p>
	                        </div>
	                        <a href="<?php echo esc_url(admin_url('themes.php?page=rt-education-school')); ?>" id="install-activate-button" class="button admin-button info-button"><?php echo __('Getting started', 'rt-education-school'); ?></a>

	                        <a href="<?php echo esc_url( RT_EDUCATION_SCHOOL_NOTICE_BUY_NOW ); ?>" target="_blank" id="go-pro-button" class="button admin-button buy-now-button"><?php echo __('Buy Now ', 'rt-education-school'); ?></a>

	                        <a href="<?php echo esc_url( RT_EDUCATION_SCHOOL_BUY_BUNDLE ); ?>" target="_blank" id="bundle-button" class="button admin-button bundle-button"><?php echo __('Get Bundle', 'rt-education-school'); ?></a>
	            	</div>
	            </div>
