...
function prime_education_getting_started_page(){ ?>
	<div class="wrap getting-started">
		...
		<div class="intro-wrap">
			<div class="intro">
				<h3><?php echo esc_html( 'Getting started with', 'prime-education' );?> <span class="theme-name"><?php echo esc_html( PRIME_EDUCATION_THEME_NAME ); ?></span> <span  class="theme-name">v<?php echo esc_html( PRIME_EDUCATION_THEME_VERSION ); ?></span> </h3>

                <span><?php ?></span>
				<h4><?php printf( esc_html__( 'You will find everything you need to get started with %1$s below.', 'prime-education' ), PRIME_EDUCATION_THEME_NAME ); ?></h4>
			</div>
		</div>
			...
			<ul class="inline-list">
				<li class="current">
                    <a id="help" href="javascript:void(0);">
                        ...
                        <?php esc_html_e( 'Getting Started', 'prime-education' ); ?>
                    </a>
                </li>
				<li>
