...
* Resolved error of On loading screen about section, logo are showing.
...
* Added hover on logo.
* Added global color for logo, phone & email.
...
* Added go pro button in slider, footer and about us section in customizer.
* Updated language folder.
...
* Added blog page button font size, text transform border radius and padding in customizer.
...
* Added tag cloud widgets in sidebar for preview.
* Tested upto WP v6.5
...
== Theme Documentation ==
Documentation : https://preview.vwthemesdemo.com/docs/free-vw-education-academy/