...
define('EDUCATION_INSIGHT_LIVE_DEMO',__('https://trial.ovationthemes.com/education-insight/','education-insight'));
}
if ( ! defined( 'EDUCATION_INSIGHT_BUY_PRO' ) ) {
define('EDUCATION_INSIGHT_BUY_PRO',__('https://www.ovationthemes.com/products/education-wordpress-theme','education-insight'));
}
if ( ! defined( 'EDUCATION_INSIGHT_PRO_DOC' ) ) {
define('EDUCATION_INSIGHT_PRO_DOC',__('https://trial.ovationthemes.com/docs/ot-education-insight-pro/','education-insight'));
}
if ( ! defined( 'EDUCATION_INSIGHT_FREE_DOC' ) ) {
define('EDUCATION_INSIGHT_FREE_DOC',__('https://trial.ovationthemes.com/docs/ot-education-insight-free-doc/','education-insight'));
}
...
function education_insight_guide() {
	...
	<div class="getting-started__header">
		...
		<div class="col-md-2">
			<div class="btn_box">
				<a class="button-primary" href="<?php echo esc_url( EDUCATION_INSIGHT_FREE_DOC ); ?>" target="_blank"><?php esc_html_e('Instructions', 'education-insight'); ?></a>
