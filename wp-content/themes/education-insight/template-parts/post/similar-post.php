...
$education_insight_post_args = array(
    'posts_per_page'    => '3',
    'orderby'           => 'rand',
...
$education_insight_ids = array();
foreach( $related as $term ) {
    $education_insight_ids[] = $term->term_id;
}

$education_insight_post_args['category__in'] = $education_insight_ids; 

$related_posts = new WP_Query( $education_insight_post_args );

if ( $related_posts->have_posts() ) : ?>
    <div id="Category-section" class="similar-post">
        <h3 class="text-center pb-3"><?php echo esc_html(get_theme_mod('education_insight_similar_text',__('Explore More','education-insight'))); ?></h3>
        <div class="row">
