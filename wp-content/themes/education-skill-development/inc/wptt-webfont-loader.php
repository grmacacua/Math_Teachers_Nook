...
if ( ! class_exists( 'Education_Skill_Development_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Education_Skill_Development_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Education_Skill_Development_WPTT_WebFont_Loader( $url );
