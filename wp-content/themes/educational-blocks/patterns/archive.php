...
/**
 * Title: Archives
 * Slug: educational-blocks/archive
 * Categories: educational-blocks, archive
 */
?>

<!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri().'/images/inner-banner.png' ); ?>","id":19,"dimRatio":50,"minHeight":300,"isDark":false,"className":"inner-cover-img","layout":{"type":"constrained","contentSize":"70%"}} -->
...
<div class="wp-block-group alignwide"><!-- wp:query-title {"type":"archive","level":2,"style":{"typography":{"textTransform":"uppercase","letterSpacing":"1px","fontSize":"42px"}},"textColor":"white","className":"wow slideInDown"} /--></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover -->
...
<h3 class="wp-block-heading has-text-align-center"><?php esc_html_e('Sorry, no post exist...','educational-blocks'); ?></h3>
<!-- /wp:heading -->
