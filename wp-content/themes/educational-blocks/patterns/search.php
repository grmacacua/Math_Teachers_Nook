...
/**
 * Title: Search
 * Slug: educational-blocks/search
 * Categories: educational-blocks, search
 */
?>

<!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri().'/images/inner-banner.png' ); ?>","id":6,"dimRatio":50,"minHeight":300,"align":"full","className":"inner-cover-img","layout":{"type":"constrained","contentSize":"70%"}} -->
...
<div class="wp-block-group"><!-- wp:query-title {"type":"search","textAlign":"left","level":2,"style":{"spacing":{"margin":{"top":"0px","right":"0px","bottom":"0px","left":"0px"}},"typography":{"letterSpacing":"1px","fontSize":"42px"}},"className":"wow slideInDown"} /--></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover -->
...
<p class="has-text-align-center has-heading-color has-text-color has-link-color"><?php esc_html_e('It seems we can’t find what you’re looking for. Perhaps searching can help.','educational-blocks'); ?></p>
<!-- /wp:paragraph -->
...
<!-- wp:column {"width":"30%"} -->
<div class="wp-block-column" style="flex-basis:30%"><!-- wp:template-part {"slug":"sidebar","theme":"educational-blocks","tagName":"div","area":"uncategorized"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->