...
<div class="wp-block-columns are-vertically-aligned-center header-details"><!-- wp:column {"verticalAlignment":"center","width":"35%","className":"info-call"} -->
<div class="wp-block-column is-vertically-aligned-center info-call" style="flex-basis:35%"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|20"}},"className":"contact-info","layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"right"}} -->
...
<!-- wp:column {"verticalAlignment":"center","width":"35%","className":"info-mail"} -->
<div class="wp-block-column is-vertically-aligned-center info-mail" style="flex-basis:35%"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|20"}},"className":"contact-info","layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"right"}} -->
...
<!-- wp:column {"verticalAlignment":"center","width":"30%","className":"top-links"} -->
<div class="wp-block-column is-vertically-aligned-center top-links" style="flex-basis:30%"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|20"}},"className":"contact-info","layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"right"}} -->
...
<div class="wp-block-column is-vertically-aligned-center nav-block-left" style="flex-basis:30%"><!-- wp:navigation {"textColor":"heading","overlayBackgroundColor":"secondary","overlayTextColor":"white","layout":{"type":"flex","justifyContent":"center"},"style":{"typography":{"textTransform":"uppercase"}},"fontSize":"small"} -->
...
<div class="wp-block-column is-vertically-aligned-center nav-block-right" style="flex-basis:70%"><!-- wp:navigation {"textColor":"heading","overlayBackgroundColor":"secondary","overlayTextColor":"white","layout":{"type":"flex","justifyContent":"center"},"style":{"typography":{"textTransform":"uppercase"}},"fontSize":"small"} -->
