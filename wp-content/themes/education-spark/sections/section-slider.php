...
$read_more      = get_theme_mod( 'education_zone_banner_read_more', __( 'Read More', 'education-spark' ) );
$es_title       = get_theme_mod( 'education_zone_banner_title', __( 'Better Education for a Better World', 'education-spark' ) );
$description    = get_theme_mod( 'education_zone_banner_description', __( 'Maecenas perspiciatis eleifend mollitia esse etiam rem harum? Sunt incididunt, sollicitudin earum anim quidem laoreet nibh, facilisis eiusmod!', 'education-spark' ) );
$link_one_label = get_theme_mod( 'education_zone_banner_link_one_label', __( 'Get Started Now', 'education-spark' ) );
$link_one_url   = get_theme_mod( 'education_zone_banner_link_one_url', '#' );
$link_two_label = get_theme_mod( 'education_zone_banner_link_two_label', __( 'Enquiry', 'education-spark' ) );
            ...
            echo '<div class="banner-wrapper">';
                ...
                <div class="banner-text">
                    <div class="container">
                        <div class="text">
                            <?php
                                if ( $es_title || $description ){
                                    if ( $es_title ) echo '<h2 class="title">'. esc_html( $es_title ).'</h2>';
