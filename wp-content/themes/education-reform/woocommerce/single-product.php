...
$education_reform_global_sidebar_layout = esc_html( get_theme_mod( 'education_reform_global_sidebar_layout',$education_reform_default['education_reform_global_sidebar_layout'] ) );
$education_reform_sidebar_column_class = 'column-order-2';
if ($education_reform_global_sidebar_layout == 'right-sidebar') {
