...
= 1.6.1 03th July 2024  =
* Add Missing Link.
* Fixed Quick Contact & Social Media in Customizer
* Minor CSS Update

= 1.6.0 30th June 2024  =
* Fixed all patterns issue.
* Fixed page layout options.
* Add new json file for patterns.
* Added new patterns.
* Fixed desing issue.

= 1.5.5 15th Jun 2023  =
* Counter Issue Fix
* Circle Progress bar(counter) Added
* Icon PHP 8.1 version issue fix


= 1.5.4 14th May 2023  =
* Customizer Advance Option Added
* Home Section have content, style and advance tab for better styling
* Advance Style - Margin, Padding, Radios, Background Option Added
* Multiple Layout Option Added
